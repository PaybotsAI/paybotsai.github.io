...
outputDirectory="$(pwd)/vip/orson_weems/MF/EPS"
thumbnailDirectory="$(pwd)/vip/orson_weems/MF/EPS/thumbnails"

# Base URL for remote c2pa manifest storage
c2paRemoteBaseURL="https://my.file.baby/vip/orson_weems/MF/EPS/"
